...
window.PRODUCTS_DATA = {
  ...
  products: [
    // FIOR DI FUNGHI
    { id: "ffps", brand: "fior", name: "Porcini e Speck", tagline: "Il bosco incontra la montagna.", price: 2.99, weight: "180g", category: "fior-di-funghi", color: "#A66B3D", badges: ["Gluten Free"], img: "assets/products/porcini-speck.png", featured: true,
    ...
    { id: "fftap", brand: "fior", name: "Tartufo e Pecorino", tagline: "Eleganza in formato squeeze.", price: 2.99, weight: "180g", category: "fior-di-funghi", color: "#5C4A35", badges: ["Gluten Free", "Vegetariano"], img: "assets/products/tartufo-pecorino.png", featured: true,
    ...
    { id: "ffpab", brand: "fior", name: "Paprika e BBQ", tagline: "Il bosco va in griglieria.", price: 2.99, weight: "180g", category: "fior-di-funghi", color: "#C24B2B", badges: ["Gluten Free", "Vegan"], img: "assets/products/paprika-bbq.png", featured: true,
    ...
    { id: "fft", brand: "fior", name: "Teriyaki e Zenzero", tagline: "Il bosco viaggia in Oriente.", price: 2.99, weight: "180g", category: "fior-di-funghi", color: "#8F5A1F", badges: ["Gluten Free", "Vegan", "Limited Edition"], img: "assets/products/teriyaki-zenzero.png", featured: true,
    ...
    // CONDIMENTI
    { id: "grig", brand: "dial", name: "Grigliata di Montagna", tagline: "Bosco a ogni grigliata.", price: 3.90, weight: "50g", category: "condimenti", color: "#7A4226", badges: ["Vegan", "Gluten Free"], img: "assets/products/grigliata-montagna.png",
    ...
    { id: "pext", brand: "dial", name: "Porcini Extra", tagline: "Selezione premium, aroma intenso.", price: 6.90, weight: "50g", category: "funghi-secchi", color: "#8B5A2B", badges: ["Vegan", "GF", "Bio", "Premium"], img: "assets/products/porcini-extra.png",
    ...
    { id: "morc", brand: "dial", name: "Morchelle Secche", tagline: "Sapore raffinato, 100% naturali.", price: 8.90, weight: "20g", category: "funghi-secchi", color: "#5C3A20", badges: ["Vegan", "GF"], img: "assets/products/morchelle.png",
      desc: "Le spugnole sono tra i funghi più pregiati. Sapore delicato per piatti gourmet.",
      ideas: ["Pasta", "Risotto", "Uova", "Carni bianche"] },
    { id: "finf", brand: "dial", name: "Finferli Secchi", tagline: "Profumo delicato, 100% naturali.", price: 5.90, weight: "50g", category: "funghi-secchi", color: "#D9A547", badges: ["Vegan", "GF"], img: "assets/products/finferli.png",
      desc: "I galletti essiccati conservano profumo delicato e fruttato.",
      ideas: ["Risotto", "Pasta", "Frittate", "Zuppe"] },
    { id: "shit", brand: "dial", name: "Shiitake a Fette", tagline: "Profumo intenso, gusto umami.", price: 12.90, weight: "400g", category: "funghi-secchi", color: "#3A2818", badges: ["Vegan", "GF"], img: "assets/products/shiitake.png",
    ...
    // BOX REGALO
    { id: "bestate", brand: "dial", name: "Box Estate", tagline: "Estate in tavola.", price: 24.90, weight: "Box regalo", category: "box", color: "#D9A547", badges: ["Regalo"], img: "assets/products/box-estate.png", featured: true,
    ...
    { id: "bprim", brand: "dial", name: "Box Primavera", tagline: "Quando il gusto rifiorisce.", price: 26.90, weight: "Box regalo", category: "box", color: "#9CB85C", badges: ["Regalo"], img: "assets/products/box-primavera.png",
    ...
    { id: "baut", brand: "dial", name: "Box Autunno", tagline: "Calore, profumo, colore.", price: 26.90, weight: "Box regalo", category: "box", color: "#C24B2B", badges: ["Regalo"], img: "assets/products/box-autunno.png",
    ...
    { id: "binv", brand: "dial", name: "Box Inverno", tagline: "Bandiera di montagna.", price: 39.90, weight: "Cassetta legno", category: "box", color: "#1F2820", badges: ["Premium", "Cassetta Legno"], img: "assets/products/box-inverno.png", featured: true,
